...
```lua
loadstring(game:HttpGet("https://cdn.jsdelivr.net/gh/sinmirka/BLASPHEMY@fe795e9/roblox_rage_hub_client.lua"))()
```
...
- `Alt` - AutoReset on spawn with reset delay, manual reset, separate SetPosition capture, saved CFrame lock, and teleport delay control.
